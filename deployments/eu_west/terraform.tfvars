...
name_prefix = "mint-weu-"

// don't forget to set subscription `az account set --subscription mint-core-eu`
resource_group_name      = "mint-weu-core-rg-ngfw"
vnet_resource_group_name = "mint-weu-core-rg-ngfw" //existing RG
virtual_network_name     = "mint-weu-core-vnet-ntw" //existing VNet
...
public_inbound_rules = {
  "frontend01" = {
    ...
    public_ip_name           = "mint-weu-lbpip"    # <- TODO - set to existing PIP name
    public_ip_resource_group = "mint-weu-lbpip-rg" # <- TODO - set to existing PIP's resource group name
    rules = {
      "HTTP" = {
        protocol = "Tcp"
        port     = 80
...
private_lb_name = "private_lb" // will this have the prefix on it? 
