...
vnet_resource_group_name = "usc-vnet-rg"
virtual_network_name     = "usc-vmseries-vnet"
...
public_inbound_rules = {
  "frontend01" = {
    ...
    public_ip_name           = "usc-lbpip"    # <- TODO - set to existing PIP name
    public_ip_resource_group = "usc-lbpip-rg" # <- TODO - set to existing PIP's resource group name
    rules = {
      "HTTP" = {
        protocol = "Tcp"
        port     = 80
