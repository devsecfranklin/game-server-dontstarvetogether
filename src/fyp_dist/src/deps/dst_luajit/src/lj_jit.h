...
#define JIT_PARAMDEF(_) \
  _(\010, maxtrace,	4000)	/* Max. # of traces in cache. */ \
  _(\011, maxrecord,	8000)	/* Max. # of recorded IR instructions. */ \
  _(\012, maxirconst,	1000)	/* Max. # of IR constants of a trace. */ \
  _(\007, maxside,	100)	/* Max. # of side traces of a root trace. */ \
  _(\007, maxsnap,	500)	/* Max. # of snapshots for a trace. */ \
  _(\011, minstitch,	2)	/* Min. # of IR ins for a stitched trace. */ \
  \
